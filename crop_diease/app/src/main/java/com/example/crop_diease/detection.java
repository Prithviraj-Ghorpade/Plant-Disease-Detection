...
public class detection extends AppCompatActivity {
    ...
    String[] classes;
    SmsManager smsManager1,smsManager2,smsManager3;
...
//        smsManager1.sendTextMessage(number,null,data,null,null);
//
//
//        smsManager2 = SmsManager.getDefault();
//                smsManager2.sendTextMessage(number,null,data,null,null);
//
//		 smsManager3 = SmsManager.getDefault();
//                smsManager3.sendTextMessage(number,null,data,null,null);
//
