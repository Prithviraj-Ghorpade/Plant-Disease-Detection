def main():
    ...
    classifier.add(Dense(3, activation = 'softmax'))  #change class no.
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/Plant_model.h5')
    ...
    plt.savefig(basepath + "/accuracy.jpg",bbox_inches='tight')
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'test'], loc='upper left')
    plt.savefig(basepath + "/loss.jpg",bbox_inches='tight')
