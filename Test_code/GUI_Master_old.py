...
#
lbl = tk.Label(root, text="PLANT LEAF DISEASE DETECTION USING MACHINE LEARNING", font=('times', 20,' bold '), height=1, width=90,bg="gray",fg="white")
lbl.place(x=0, y=650)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='E:\Test_code\test_set\test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
